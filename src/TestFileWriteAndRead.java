...
import java.util.Collection;
 ...
 public class TestFileWriteAndRead{
     public static void main(String[] args){
         ...
         smelterUnthreaded.addData(new CandleStickFixedDouble(12, 4, 9, 2, 5, 10.5));
         smelterUnthreaded.addData(new CandleStickFixedDouble(13, 4.1, 9.7, 2.2, 5, 15.6));
 
         System.out.println("Setting file to: "+binFileName1);
