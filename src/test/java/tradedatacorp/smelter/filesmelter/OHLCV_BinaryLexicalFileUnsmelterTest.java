...
public class OHLCV_BinaryLexicalFileUnsmelterTest{
    ...
    private static boolean[][] cachedOneDatapointHeader;
    private static boolean[][] cachedTwoDatapointsHeader;
    private static boolean[][] cachedThreeDatapointsHeader;
    ...
    static void initialize(){
        ...
        Path tmpCachePathOneDP = testFileFetcher.getFilePath("smelter/filesmelter/OneDatapoint.brclmb");
        Path tmpCachePathTwoDP = testFileFetcher.getFilePath("smelter/filesmelter/TwoDatapoints.brclmb");
        Path tmpCachePathThreeDP = testFileFetcher.getFilePath("smelter/filesmelter/ThreeDatapoints.brclmb");

        OHLCV_BinaryLexicalFileUnsmelter tmpHeaderReader = new OHLCV_BinaryLexicalFileUnsmelter();

        cachedOneDatapointHeader = tmpHeaderReader.unsmeltFileHeader(tmpCachePathOneDP);
        cachedTwoDatapointsHeader = tmpHeaderReader.unsmeltFileHeader(tmpCachePathTwoDP);
        cachedThreeDatapointsHeader = tmpHeaderReader.unsmeltFileHeader(tmpCachePathThreeDP);
    }
    ...
    class TestsForOneDatapoint{
        ...
        @Test
        public void unsmeltAllCollectionCachedHeaderTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
            ...
            Collection<StickDouble> actualStickCollection = reader.unsmeltFileToCollection(filepath, cachedOneDatapointHeader);
            assertEquals(1,actualStickCollection.size());
        ...
        @Test
        public void unsmeltAllArrayCachedHeaderTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
            ...
            StickDouble[] actualStickArr = reader.unsmeltFileToArray(filepath, cachedOneDatapointHeader);
            assertEquals(1,actualStickArr.length);
        ...
        @Test
        public void OneDatapointExtractOnlyDataPointCollectionCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{expectedStickList[0]};
            StickDouble expectedStick0 = expectedStickList[0];
        ...
        @Test
        public void OneDatapointExtractOnlyDataPointArrayCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{expectedStickList[0]};
            StickDouble expectedStick0 = expectedStickList[0];
    ...
    class TestsForTwoDatapoints{
        ...
        @Test
        public void unsmeltAllFromCollectionCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
            ...
            Collection<StickDouble> actualStickCollection = reader.unsmeltFileToCollection(filepath, cachedTwoDatapointsHeader);
            assertEquals(2,actualStickCollection.size());
        ...
        public void unsmeltAllFromArrayTest(){
            ...
            StickDouble[] actualStickArr = reader.unsmeltFileToArray(filepath);
            assertEquals(2, actualStickArr.length);
        ...
        @Test
        public void unsmeltAllFromArrayCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
            ...
            StickDouble[] actualStickArr = reader.unsmeltFileToArray(filepath, cachedTwoDatapointsHeader);
            assertEquals(2, actualStickArr.length);
        ...
        @Test
        public void TwoDatapointsExtractFirstDataPointTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
        ...
        @Test
        public void TwoDatapointsExtractFirstDataPointCachedHeaderTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
        ...
        @Test
        public void TwoDatapointsExtractSecondDataPointTest(){
        ...
        @Test
        public void TwoDatapointsExtractSecondDataPointCachedHeaderTest(){
            StickDouble expectedStick1 = expectedStickList[1];
            StickDouble actualStick1; //Actual Stick saved in the file.
        ...
        @Test
        public void TwoDatapointsExtractAllDataPointsTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
        ...
        @Test
        public void TwoDatapointsExtractAllDataPointsCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
    ...
    class TestsForThreeDatapoints{
        ...
        public void unsmeltAllFromCollectionCachedHeaderTest(){
            ...
            Collection<StickDouble> actualStickCollection = reader.unsmeltFileToCollection(filepath, cachedThreeDatapointsHeader);
            assertEquals(3,actualStickCollection.size());
        ...
        public void unsmeltAllFromArrayCachedHeaderTest(){
            ...
            StickDouble[] actualStickArr = reader.unsmeltFileToArray(filepath, cachedThreeDatapointsHeader);
            assertEquals(3, actualStickArr.length);
        ...
        @Test
        public void ThreeDatapointsExtractFirstDataPointTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
        ...
        @Test
        public void ThreeDatapointsExtractFirstDataPointCachedHeaderTest(){
            StickDouble expectedStick0 = expectedStickList[0];
            StickDouble actualStick0; //Actual Stick saved in the file.
        ...
        @Test
        public void ThreeDatapointsExtractSecondDataPointTest(){
            StickDouble expectedStick1 = expectedStickList[1];
            StickDouble actualStick1; //Actual Stick saved in the file.
        ...
        @Test
        public void ThreeDatapointsExtractSecondDataPointCachedHeaderTest(){
            StickDouble expectedStick1 = expectedStickList[1];
            StickDouble actualStick1; //Actual Stick saved in the file.
        ...
        @Test
        public void ThreeDatapointsExtractThirdDataPointTest(){
        ...
        @Test
        public void ThreeDatapointsExtractThirdDataPointCachedHeaderTest(){
            StickDouble expectedStick2 = expectedStickList[2];
            StickDouble actualStick2; //Actual Stick saved in the file.
        ...
        @Test
        public void ThreeDatapointsExtractFirstAndSecondDataPointTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
        ...
        @Test
        public void ThreeDatapointsExtractFirstAndSecondDataPointCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1]
            };
        ...
        @Test
        public void ThreeDatapointsExtractSecondAndThirdDataPointTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[1],
                expectedStickList[2]
            };
        ...
        @Test
        public void ThreeDatapointsExtractSecondAndThirdDataPointCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[1],
                expectedStickList[2]
            };
        ...
        @Test
        public void ThreeDatapointsExtractAllDataPointsTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1],
                expectedStickList[2]
        ...
        @Test
        public void ThreeDatapointsExtractAllDataPointsCachedHeaderTest(){
            StickDouble[] expectedStickArr = new StickDouble[]{
                expectedStickList[0],
                expectedStickList[1],
                expectedStickList[2]
